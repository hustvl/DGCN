...
def parse_args():
    ...
    parser.add_argument('--pred', dest='pred_dir',
                        ...
                        default='./result/evaluation/', type=str)
    ...
    parser.add_argument('--gt', dest='gt_dir',
                        ...
                        default='/workspace/fengjp/data/VOC2012/SegmentationClassAug/', type=str)
    parser.add_argument('--test_ids', dest='test_ids',
                        help='test ids file path',
                        default='./dataset/list/val.txt', type=str)
    parser.add_argument('--save_path', dest='save_path',
                        help='result file path',
                        default='./result_gc_res101.txt', type=str)
